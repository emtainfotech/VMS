...
urlpatterns = [
    ...
    path('my-assigned-candidates/', employee_assigned_candidate_list, name='employee_assigned_candidate_list'),
    path('api/my-assigned-candidates/', employee_get_assigned_candidates_api, name='employee_get_assigned_candidates_api'),
